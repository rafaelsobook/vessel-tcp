...
exports.F_RANK_QUEST_COUNT = void 0;
exports.createSlaySlimesQuest = createSlaySlimesQuest;
...
function createSlaySlimesQuest(requiredNumber, pos) {
    return {
        questId: (0, tools_1.randNumString)(),
        qName: "slaySlimes",
        qTtle: "Slay Slimes",
        ...
        reward: { receiveRewardType: "bronze", rewardItems: [
                {
                    itemId: (0, tools_1.randNumString)(), // should be string also in client
...
exports.F_RANK_QUEST_COUNT = 10;
const positions = scatterPositions(exports.F_RANK_QUEST_COUNT);
exports.default = positions.map(pos => createSlaySlimesQuest(2, pos));
